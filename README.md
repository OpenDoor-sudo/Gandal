...
- **Code** — a Python playground (editor, Run, output, pass/fail tests, hints). It is not a lesson and it is not tied to a topic. Python runs in the page with Pyodide. English and French only.
